    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="{{ route('welcome') }}" class="flex items-center justify-between mr-4">
                <img src="{{ asset('img/DelfinBeta_Logotipo.png') }}" class="mr-3 h-8" alt="DelfinBeta ogotipo" title="DelfinBeta ogotipo" />
            </a>
        </div>
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" class="flex mx-3 text-sm rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                ...
                <span class="hidden md:block px-2 leading-8">{{ Auth::user()->name }}</span>
                <img class="w-8 h-8 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gough.png" alt="photo" title="photo" />
            </button>
            <!-- Dropdown Menu -->
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            @csrf
                            <a href="{{ route('logout') }}"  @click.prevent="$root.submit();" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                Salir
                            </a>
                        </form>
                    </li>
